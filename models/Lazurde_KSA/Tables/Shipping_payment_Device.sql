select safe_divide(PaymentPage,Transaction) payment_trnx ,D_ga_deviceCategory,StartDate,'Lazurde_KSA' Halo_Country from(
...
from `noted-computing-279322.halo_1_1_lazurdeksa.fGABaseShoppingStages` )
