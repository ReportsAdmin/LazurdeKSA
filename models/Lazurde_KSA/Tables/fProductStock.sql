...
select distinct prd.product_id , prd.stock as inventory, max(pei.value) as MRP, max(pei.value) as Selling_Price from `noted-computing-279322.halo_1_1_lazurdeksa.fproducts` prd
