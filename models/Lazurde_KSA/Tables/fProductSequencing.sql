select *,row_number() over (partition by category_L1 order by RevPerImpression desc) DesiredPositioning,'Lazurde_KSA' Halo_Country
from(
...
`noted-computing-279322.halo_1_1_lazurdeksa.refProducts` b
